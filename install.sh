...
echo -e "  ${WHITE}│${NC}      ${BOLD}${WHITE}  ,╗╗╖${NC}                        ${WHITE}│${NC}"
echo -e "  ${WHITE}│${NC}      ${BOLD}${WHITE} ╱╱  ╲╲${NC}                       ${WHITE}│${NC}"
echo -e "  ${WHITE}│${NC}      ${BOLD}${WHITE}╱╱ ╱╲ ╲╲  ╱${NC}                   ${WHITE}│${NC}"
echo -e "  ${WHITE}│${NC}      ${BOLD}${WHITE}╲╲╱  ╲ ╲╲╱${NC}                    ${WHITE}│${NC}"
echo -e "  ${WHITE}│${NC}      ${BOLD}${WHITE} ╲╲  ╱╱${NC}                       ${WHITE}│${NC}"
...
echo -e "  ${WHITE}│${NC}    ${DIM}kerstel.dev${NC}                       ${WHITE}│${NC}"
echo -e "  ${WHITE}│${NC}                                     ${WHITE}│${NC}"
echo -e "  ${WHITE}└─────────────────────────────────────┘${NC}"
...
# Copy menu bar bird icon PNGs
for icon in MenuBarIcon.png "MenuBarIcon@2x.png"; do
    if [[ -f "$INSTALL_DIR/Sources/KerstelCore/Resources/$icon" ]]; then
        cp "$INSTALL_DIR/Sources/KerstelCore/Resources/$icon" "$APP_BUNDLE/Contents/Resources/$icon"
    fi
done
...
cmd_open() {
    ...
    echo -e " ${PASS}  Kerstel started — look for the bird in the menu bar"
}
...
echo -e "  ${WHITE}│${NC}                                     ${WHITE}│${NC}"
echo -e "  ${WHITE}│${NC}  Look for the bird in your menu bar  ${WHITE}│${NC}"
